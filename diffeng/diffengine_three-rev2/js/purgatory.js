// Uses classic (non-module) Three.js scripts loaded by purgatory.html.
// This avoids ESM+CORS issues on GitHub Pages and other static hosts.
...
if (!THREE || !OrbitControls || !GLTFLoader) {
  ...
  container.innerHTML = '<p style="padding:12px;color:#fff;font-family:system-ui, -apple-system, Segoe UI, Roboto, sans-serif;">Three.js failed to load. If you are on a restricted network, try a different connection or self-host the three.js files.</p>';
  throw new Error('Three.js / OrbitControls / GLTFLoader not available');
}
